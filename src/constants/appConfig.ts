...
export const TIME_RECORDER_DEMO_DATA: TimeRecorderType[] = [
        ...
        {
          emp_id: "001",
          datetime: `${formattedYesterday}T07:30:00+0900`,
          role: "oven",
          type: "clock_in",
          note: "",
        },
        ...
        {
          emp_id: "001",
          datetime: `${formattedYesterday}T13:10:00+0900`,
          role: "oven",
          type: "break_begin",
          note: "",
        },
        {
          emp_id: "001",
          datetime: `${formattedYesterday}T13:51:00+0900`,
          role: "oven",
          type: "break_end",
          note: "",
        },
        {
          emp_id: "001",
          datetime: `${formattedYesterday}T17:00:00+0900`,
          role: "oven",
          type: "clock_out",
          note: "",
        },
        {
          emp_id: "003",
          datetime: `${formattedYesterday}T07:00:00+0900`,
          role: "dough",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "003",
          datetime: `${formattedYesterday}T12:00:00+0900`,
          role: "dough",
          type: "break_begin",
          note: "",
        },
        {
          emp_id: "003",
          datetime: `${formattedYesterday}T12:50:00+0900`,
          role: "dough",
          type: "break_end",
          note: "",
        },
        {
          emp_id: "003",
          datetime: `${formattedYesterday}T16:36:00+0900`,
          role: "dough",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T08:58:00+0900`,
          role: "wrapping",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T14:00:00+0900`,
          role: "wrapping",
          type: "break_begin",
          note: "",
        },
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T14:58:00+0900`,
          role: "cafe",
          type: "break_end",
          note: "",
        },
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T17:15:00+0900`,
          role: "wrapping",
          type: "role_change",
          note: "",
        },
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T18:15:00+0900`,
          role: "wrapping",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "017",
          datetime: `${formattedYesterday}T08:30:00+0900`,
          role: "shaping",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "017",
          datetime: `${formattedYesterday}T12:03:00+0900`,
          role: "shaping",
          type: "break_begin",
          note: "",
        },
        {
          emp_id: "017",
          datetime: `${formattedYesterday}T12:35:00+0900`,
          role: "shaping",
          type: "break_end",
          note: "",
        },
        {
          emp_id: "017",
          datetime: `${formattedYesterday}T17:55:00+0900`,
          role: "shaping",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "005",
          datetime: `${formattedYesterday}T07:55:00+0900`,
          role: "sandwich",
          type: "clock_in",
          note: "",
        },
         {
          emp_id: "005",
          datetime: `${formattedYesterday}T13:04:00+0900`,
          role: "sandwich",
          type: "break_begin",
          note: "",
        },
        {
          emp_id: "005",
          datetime: `${formattedYesterday}T13:42:00+0900`,
          role: "cafe",
          type: "break_end",
          note: "",
        },
        {
          emp_id: "005",
          datetime: `${formattedYesterday}T16:00:00+0900`,
          role: "cafe",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "012",
          datetime: `${formattedYesterday}T11:30:00+0900`,
          role: "shaping",
          type: "role_change",
          note: "",
        },
        ...
        {
          emp_id: "012",
          datetime: `${formattedYesterday}T13:00:00+0900`,
          role: "shaping",
          type: "break_end",
          note: "",
        },
        {
          emp_id: "012",
          datetime: `${formattedYesterday}T15:00:00+0900`,
          role: "shaping",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "027",
          datetime: `${formattedYesterday}T16:15:00+0900`,
          role: "sales",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "027",
          datetime: `${formattedYesterday}T22:05:00+0900`,
          role: "sales",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "028",
          datetime: `${formattedYesterday}T10:55:00+0900`,
          role: "sales",
          type: "clock_in",
          note: "",
        },
        ...
        {
          emp_id: "029",
          datetime: `${formattedYesterday}T10:03:00+0900`,
          role: "sales",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "029",
          datetime: `${formattedYesterday}T16:04:00+0900`,
          role: "sales",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "030",
          datetime: `${formattedYesterday}T16:48:00+0900`,
          role: "sales",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "030",
          datetime: `${formattedYesterday}T22:55:00+0900`,
          role: "sales",
          type: "clock_out",
          note: "",
        },
        ...
        {
          emp_id: "031",
          datetime: `${formattedYesterday}T08:54:00+0900`,
          role: "sales",
          type: "clock_in",
          note: "",
        },
        {
          emp_id: "031",
          datetime: `${formattedYesterday}T13:38:00+0900`,
          role: "sales",
          type: "clock_out",
          note: "",
        },
...
export const SHIFT_DEMO_DATA: ShiftType[] =  [
        ...
        {
          emp_id: "001",
          datetime: `${formattedYesterday}T08:00:00+0900`,
          role: "oven",
          type: "clock_in",
        },
        ...
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T09:00:00+0900`,
          role: "wrapping",
          type: "clock_in",
        },
        {
        ...
        {
          emp_id: "008",
          datetime: `${formattedYesterday}T18:00:00+0900`,
          role: "wrapping",
          type: "clock_out",
        },
        ...
        {
          emp_id: "017",
          datetime: `${formattedYesterday}T17:30:00+0900`,
          role: "shaping",
          type: "clock_out",
        },
        ...
        {
          emp_id: "027",
          datetime: `${formattedYesterday}T22:00:00+0900`,
          role: "sales",
          type: "clock_out",
        },
        ...
        {
          emp_id: "028",
          datetime: `${formattedYesterday}T11:00:00+0900`,
          role: "sales",
          type: "clock_in",
        },
        {
        ...
        {
          emp_id: "029",
          datetime: `${formattedYesterday}T10:00:00+0900`,
          role: "sales",
          type: "clock_in",
        },
        {
        ...
        {
          emp_id: "030",
          datetime: `${formattedYesterday}T22:30:00+0900`,
          role: "sales",
          type: "clock_out",
        },
