...
export const EMPLOYEE_DEMO_DATA: Employee[] = [
        ...
        { id: "008", name: "中村里奈", roles: ["sandwich", "cafe", "sales"] },
        { id: "009", name: "小林直樹", roles: ["sandwich", "cafe", "sales"] },
        { id: "010", name: "加藤優子", roles: ["sandwich", "cafe"] },
        { id: "011", name: "吉田亮", roles: ["sandwich", "cafe"] },
        { id: "012", name: "山田恵美", roles: ["sandwich"] },
